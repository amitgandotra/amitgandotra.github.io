...
- [x] **Mobile checked in real Chrome** (2026-09-21) with `tools/checks/mobile.js` at 375px and 320px across all 69 pages: no sideways scroll, tap targets at least 40px on touch devices. Still to do: a pass at desktop width and on a real phone/Safari (only Chrome was tested), plus a visual review of the pattern finder and quiz states.
